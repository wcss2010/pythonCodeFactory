...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.txtNormalText.setGeometry(QtCore.QRect(10, 10, 781, 381))
        self.txtNormalText.setObjectName("txtNormalText")
        self.txtNormalCodeSearch = QtWidgets.QTextEdit(self.tabNormal)
        self.txtNormalCodeSearch.setGeometry(QtCore.QRect(10, 400, 781, 31))
        ...
        self.txtEntityAndDAOText.setGeometry(QtCore.QRect(10, 10, 781, 381))
        self.txtEntityAndDAOText.setObjectName("txtEntityAndDAOText")
        self.txtEntityAndDAOCodeSearch = QtWidgets.QTextEdit(self.tabEntityAndDAO)
        self.txtEntityAndDAOCodeSearch.setGeometry(QtCore.QRect(10, 400, 781, 31))
        ...
        self.plWaitBox.setGeometry(QtCore.QRect(10, 420, 341, 151))
